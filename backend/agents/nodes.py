...
async def appeal_drafting(state: ClaimState) -> dict[str, Any]:
    ...
    Delegates to the AppealDraftingAgent which:
        1. Retrieves payer policies and clinical guidelines from Qdrant
        2. Calls Gemini (preferred for long-context generation)
